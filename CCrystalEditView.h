...
#if !defined(AFX_TCCCRYSTALEDITVIEW_H__8F3F8B63_6F66_11D2_8C34_0080ADB86836__INCLUDED_)
#define AFX_TCCCRYSTALEDITVIEW_H__8F3F8B63_6F66_11D2_8C34_0080ADB86836__INCLUDED_
...
// Operations
public:
	void PasteSelection(LPCTSTR pszNewText,int partial);
	void BeginUnitPaste();
	void EndUnitPaste();
	void UnitPasteSelection(LPCTSTR pszNewText);
	CCrystalEditView();
	~CCrystalEditView();
...
#endif // !defined(AFX_TCCCRYSTALEDITVIEW_H__8F3F8B63_6F66_11D2_8C34_0080ADB86836__INCLUDED_)
